...
export default function FontesProtestoPage(props) {
    ...
    async function removeRows(e){
        for (const item of e) {
            await axios.delete('/api/mapcon/fonteprotesto', { data: { num_seq_fonte_protesto: item.num_seq_fonte_protesto } })
        }
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="p-fluid p-formgrid p-grid p-mt-lg-4 p-mt-4">
                    <div className="p-field p-col-12 p-md-12">
                        ...
                        <Controller name="desc_fonte_protesto" rules={{ required: true }} control={control} render={({ onChange, value }) =>
