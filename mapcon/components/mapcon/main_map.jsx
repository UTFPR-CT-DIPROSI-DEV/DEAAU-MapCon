...
export default function MainMap({ conflitos }) {
    ...
    const boundsParana = [
        [-26.7166667, -54.6188889],
        [-22.5161111, -48.0936111]
    ]
    ...
    return (
        <>
            <MapContainer zoomControl={true} style={{ height: "calc(100vh - 43px - 1.125rem)", width: "100vw" }} center={latLng(position)} zoom={10} scrollWheelZoom={true} minZoom={7} maxZoom={18} maxBounds={boundsParana} maxBoundsViscosity={0.35}>
                <TileLayer
